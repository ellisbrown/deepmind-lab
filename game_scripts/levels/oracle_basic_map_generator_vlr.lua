...
local object_map = {"A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", "L", "M", "N", "O", "Q", "R", "S", "T", "U"}
local angles = {"270", "90", "0", "180", "315", "45", "0"}
...
function api:nextMap()
  local obj_id = math.floor(api._count / 20) + 1
  local object = object_map[obj_id]
  local map_id = api._count % 6
  local path = "./game_scripts/levels/vlr_maps_oracle/vlr_maps_" .. object .. "_" .. map_id .. ".txt"
...
function api:updateSpawnVars(spawnVars)
  spawnVars.angle = angles[(api._count - 1) % 6 + 1]
